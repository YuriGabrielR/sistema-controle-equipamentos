...
public class EquipamentoCriarRequestDTO{

    @Size(min=4, message="O campo NOME deve conter pelo menos 4 caracteres.")
    @NotNull(message="O campo NOME não pode ser vazio ")
    private String nome;

    @NotNull(message="O campo Localização no Estoque não pode ser vazio ")
    @Size(min=4, message="O campo LOCALIZAÇÃO ESTOQUE deve conter pelo menos 4 caracteres.")
    @NotBlank(message="O campo LOCALIZAÇÃO ESTOQUE não pode conter espaços vazios")
    ...
    @NotNull(message="O campo STATUS não pode ser vazio")
    @NotBlank(message="O campo MODELO não pode conter espaços vazios")
    @Size(min=4, message="O campo MODELO deve conter pelo menos 4 caracteres.")
    private String modelo;

    @NotNull(message="O campo NÚMERO DE SÉRIE não pode ser vazio")
    @NotBlank(message="O campo NUMÉRO DE SÉRIE não pode conter espaços vazios")
